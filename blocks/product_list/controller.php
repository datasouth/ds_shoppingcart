...
namespace Concrete\Package\DsShoppingcart\Block\ProductList;
...
class Controller extends BlockController
{
    ...
    {
        return t("List Products based on type, area.");
    }
    ...
    public function save($args)
    {
        ...
        $args['showBuyButton'] = ($args['showBuyButton']) ? '1' : '0';
        $args['showProductPrice'] = ($args['showProductPrice']) ? '1' : '0';
        $args['showProductSKU'] = ($args['showProductSKU']) ? '1' : '0';        
