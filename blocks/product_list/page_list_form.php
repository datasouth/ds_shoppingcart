...
<div class="row pagelist-form">
    <div class="col-xs-6">
        ...
        <div class="form-group">
         ...
         <!--new for shopping cart plugin -->
        <fieldset>
        <legend><?php echo t('Product Information') ?></legend>           
            <div class="form-group">
                <div class="checkbox">
                <label>
                    <input type="checkbox" name="showBuyButton" id="showBuyButton"
                           value="1" <?php echo $showBuyButton ? 'checked="checked"' : '' ?> />
                    <?php echo t('Show Buy Buttons') ?>
                </label>
            </div>
            <div class="form-group">
                <div class="checkbox">
                <label>
                    <input type="checkbox" name="showProductPrice" id="showProductPrice"
                           value="1" <?php echo $showProductPrice ? 'checked="checked"' : '' ?> />
                    <?php echo t('Show Product Price') ?>
                </label>
            </div>
            <div class="form-group">
                <div class="checkbox">
                <label>
                    <input type="checkbox" name="showProductSKU" id="showProductSKU"
                           value="1" <?php echo $showProductSKU ? 'checked="checked"' : '' ?> />
                    <?php echo t('Show Product SKU') ?>
                </label>
            </div>
